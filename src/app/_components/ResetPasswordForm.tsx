  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white p-4">
      <div className="w-full max-w-md bg-gray-100 rounded-2xl shadow-lg p-6">
        <h1 className="text-xl font-semibold mb-4 text-center">Réinitialisation du mot de passe</h1>

        {success ? (
          <div className="flex flex-col items-center justify-center gap-4 py-6">
            <p className="text-green-700 font-semibold text-center">
              Ton mot de passe a bien été mis à jour 🎉<br />Redirection vers la connexion...
            </p>
          </div>
        ) : (
